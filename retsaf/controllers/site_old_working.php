...
class Site extends CI_Controller {
	...
	{	
		...
		$tag = $formdata['Tag'];
 		...
 		$f_LatLng='{ "H":'.$formdata['F_lat'].', "L":'.$formdata['F_lon'].'}';
	 	$LatLng='{ "H":'.$formdata['G_lat'].', "L":'.$formdata['G_lon'].'}';
        ...
        if(isset($_FILES['fileToUpload']['name']) && (!empty($_FILES['fileToUpload']['name'])))
		{
			...
			{   
				...
				$path = 'event_images/'.$_FILES['fileToUpload']['name'];
      			$detail ='{ "name":"'.$formdata['name'].'","address":"'.$formdata['starting_location'].'","price" :"","discount" :"","date":"'.$formdata['bday'].'","startTime":"'.$formdata['s_time'].'","endTime":"'.$formdata['usr_time'].'","about":"'.$formdata['Description'].'","Reviews":"expert review","type":"'.$formdata['Tag'].'","Info_1":"'.$formdata['Info_1'].'","Info_2":"'.$formdata['Info_2'].'","Info_3":"'.$formdata['Info_3'].'","Path":"'.$path.'"}';
