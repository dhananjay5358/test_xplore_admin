...
// assert($CLIENT_ID, "SYkQR7uLFuGPWGhvN2XJgw.");
// assert($CLIENT_SECRET, "yYMe0Ywmr65wAq9X05JOuE5uG54cKNHKdecttbYSrMCfaNgTrTlXtxL413eQx6RY");
// API constants, you shouldn't have to change these.
var $API_HOST = "https://api.yelp.com";
var $SEARCH_PATH = "/v3/businesses/search";
var $BUSINESS_PATH = "/v3/businesses/";  // Business ID will come after slash.
var $TOKEN_PATH = "/oauth2/token";
var $GRANT_TYPE = "client_credentials";
// Defaults for our simple example.
var $DEFAULT_TERM = "dinner";
var $DEFAULT_LOCATION = "170 w polk street chicago,il,united state";
var $SEARCH_LIMIT = 3;
/**
...
function obtain_bearer_token() {
    try {
        ...
        $postfields = "client_id=" . 'SYkQR7uLFuGPWGhvN2XJgw' .
