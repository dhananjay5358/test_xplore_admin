...
<html> 
    <head>
        <title>Production Xplore - Event</title>
    ...
    <body>
        <div>
            <h1>Upload Events data :<br/><a class="ajax-link" href="<?php echo site_url('site/viewEvents');?>">HOME</a></h1>
                <form id="test" name="test" action="<?php echo site_url('site/Save_Events'); ?>" method="POST" class="form-panel col-sm-10" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                        <input type="text" class="form-control" name="Custom_lat_lon" id="Custom_lat_lon" placeholder="Longitude" />
                                 </div>
                            </div> 
                        </div> 
                        <br/>
                        ...
                        <br/>   
                        <div class="form-group">
                             <label for="Tag" class="col-sm-4 control-label">
                                    <b>Tag :</b>
                             </label>
                             <div class="col-sm-8">
                        ...
                        <!-- <div class="form-group">
                             ...
                             <div class="col-sm-4">
                                    <input type="text" class="form-control" name="usr_start_date" placeholder="Start date" id="usr_start_date"/>
                             </div>
                             <div class="col-sm-4">
                                    <input type="text" class="form-control" name="usr_start_time" placeholder="Start time" id="usr_start_time"/>
                             </div>
                        </div>    -->
                        ...
                        <div class="form-group">
                             ...
                             <div class="col-sm-4">
                                    <input type="text" class="form-control" name="bday" id="bday" />
                             </div>
                        ...
                        <div class="form-group">
                             <label for="usr_time" class="col-sm-4 col-sm-4 control-label">
                                    <b>Event ends date and time:</b>
                             </label>
                             <div class="col-sm-4">
                                    <input type="text" class="form-control" placeholder="End date" name="usr_time" id="usr_time"/>
                             </div>
                             <div class="col-sm-4">
                                    <input type="text" class="form-control" placeholder="End time" name="e_time" id="e_time"/>
                             </div>
                        </div>   
                        <br/>
                        <br/> 
                        ...
                        <div class="form-group col-sm-12">
                             ...
                             <div class="col-sm-4">
                                    <input type="radio" name="feautured" value="0">Featured<br>
                            </div>
                            <div class="col-sm-4">
                                    <input type="radio" name="feautured" value="1">Unfeatured<br>
                            </div>
                        </div>
                        <br/>
                        <br/> 
    ...
    <script type="text/javascript">
        $( function() {
            ...
            $( "#bday" ).datepicker({dateFormat: 'dd-M-yy'});
