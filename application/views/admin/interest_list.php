			...
			<!-- content starts -->
				...
				<div class="box span12">
					...
					<div class="box-content">	
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable" id="kendo_interest_">
	 ...
	 <script>
                    ...
                    $(document).ready(function() {
                        ...
                        dataSource = new kendo.data.DataSource({
                            ...
                            transport: {
                                read:{
                                    url: "<?php echo site_url('admin/interests/index_kendo');?>",                            
                                    dataType: "json",
