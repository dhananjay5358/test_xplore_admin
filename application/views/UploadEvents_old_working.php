    ...
    <body>
        <div>
            <h1>Upload places data ::</h1> 
				<form id="test" name="test" class="form-panel col-sm-10 col-sm-10">
                        ...
                        <div class="form-group">
                             ...
                             <div class="col-sm-4">
                                    <input type="text" class="form-control" name="place_location" id="place_location" required/>
                             </div>
			<div class="col-sm-4">
                                    <input type="text" class="form-control" name="F_Lat_Long" id="F_Lat_Long" required/>
                             </div>
                        </div> 
                        <br/>
                        <br/>
				...
				<div class="col-sm-4">
                                    <input type="text" class="form-control" name="G_Lat_Long" id="G_Lat_Long" required/>
                             </div>
                        </div> 
                        <br/>
                        <br/>               
